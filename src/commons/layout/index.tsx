...
type LayoutProps = {
  children: ReactNode;
  /** 서버 레이아웃에서 조회한 게스트 코스·트랙 작성 여부(합산 1건 이상). 비게스트·미로그인은 false로 두면 된다. */
...
export function Layout({ children, hasWrittenItem = false }: LayoutProps) {
